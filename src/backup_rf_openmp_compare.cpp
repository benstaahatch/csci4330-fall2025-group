...
int main(int argc, char* argv[])
{
    ...
    if (!parseCompareArgs(argc, argv, experiment, &num_threads)) {
        return 1;
    }
    omp_set_num_threads(num_threads);

    cout << "============================================================\n";
    cout << "Backup OpenMP Random Forest With Current Validation Protocol\n";
    cout << "============================================================\n";
    ...
    string run_dir = makeRunDirectory(experiment, "backup_openmp_rf", 1, num_threads);
    writeMetricsJson(
        run_dir,
